# redoc [![Go Package][gopkg]][gopkg-link]

Package `redoc` provides a ReDoc server.

[gopkg]: https://pkg.go.dev/badge/github.com/kenshaw/redoc.svg (Go Package)
[gopkg-link]: https://pkg.go.dev/github.com/kenshaw/redoc
